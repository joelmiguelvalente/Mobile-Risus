...
<div class="head_perfil clearBoth">
    ...
    <ul class="counters clearBoth">
        <li>{$tsInfo.stats.user_puntos|kmg}<small>Puntos</small></li>
        <li><a href='{$tsConfig.url}/perfil/{$tsInfo.nick}/posts'>{$tsInfo.stats.user_posts|kmg}<small>Posts</small></a></li>
        <li>{$tsInfo.stats.user_seguidores|kmg}<small>Seguidores</small></li>
    </ul>
</div>
{if $tsAction == ''}
